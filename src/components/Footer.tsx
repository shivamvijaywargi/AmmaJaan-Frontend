    ...
    <footer className="text-gray-600 body-font border-t-2 bg-white">
      <div className="px-5 py-4 mx-auto max-w-7xl flex items-center sm:flex-row flex-col">
        ...
        <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
          <a
            target="_blank"
            href="https://facebook.com/shivamvijaywargi"
          ...
          <a
            target="_blank"
            href="https://twitter.com/shivamvijaywarg"
          ...
          <a
            target="_blank"
            href="https://instagram.com/shivamvijaywargi"
            className="ml-3 text-gray-500"
          >
            <svg
              fill="none"
          ...
          <a
            target="_blank"
            href="https://linkedin.com/in/shivamvijaywargi"
            className="ml-3 text-gray-500"
          >
            <svg
              fill="currentColor"
